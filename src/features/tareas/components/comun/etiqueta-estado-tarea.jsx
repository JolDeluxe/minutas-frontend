...
const ESTADO_CONFIG = {
    ...
    EN_REVISION: { label: 'En Revisión', bg: 'bg-blue-100 text-blue-700 border-blue-300' },
    CERRADA: { label: 'Cerrada', bg: 'bg-estado-cerrado/10     text-estado-cerrado     border-estado-cerrado/30' },
